 ...
 * 
 * This program initializes a camera capture, sets up the YOLO model for human detection,
 * and continuously processes video frames to detect and track humans.
 * 
...
int main() {
    ...
    try {
         ...
         * 
         * Continuously captures frames from the camera, processes them for human detection
         * and tracking, and displays the results.
         */
        while (true) {
            cap >> frame;
            if (frame.empty()) {
